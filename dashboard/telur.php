        ...
        <div class="container">
            ...
            <div class="row about-row">
                <div class="col-md-5 about-img">
                    <img src="assets/images/kartun/telur.png" alt="">
                </div>
                <div class="col-md-6 about-text">
                    <h1>Harga Telur Ayam Di Wilayah Kota Medan</h1>
                    <p>Accurate information of work. Visualization achieved through the boardNutrisi yang terkandung di dalam sebuah telur cukup lengkap, mulai dari asam amino yang komplit, lemak, vitamin, mineral hingga lutein.</p>
