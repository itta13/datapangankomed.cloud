        ...
        <div class="container">
            ...
            <div class="row about-row">
                <div class="col-md-5 about-img">
                    <img src="assets/images/kartun/beras.png" alt="">
                </div>
                <div class="col-md-6 about-text">
                    <h1>Harga Beras Di Wilayah Kota Medan</h1>
                    <p>Dalam rangka memenuhi kebutuhan pangan, trend ke depan bukan saja dari sisi kecukupan secara kuantitas tetapi juga memperhatikan kandungan gizi dari beras.</p>
