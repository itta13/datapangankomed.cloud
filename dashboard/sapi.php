        ...
        <div class="container">
            ...
            <div class="row about-row">
                <div class="col-md-5 about-img">
                    <img src="assets/images/kartun/sapi.png" alt="">
                </div>
                <div class="col-md-6 about-text">
                    <h1>Harga Daging Sapi Di Wilayah Kota Medan</h1>
                    <p>Daging sapi merupakan salah satu bahan pangan asal hewani yang banyak dikonsumsi oleh masyarakat.</p>
