        ...
        <header id="menu-jk" class="container-fluid">
            <div class="container">
                <div class="row head-ro">
                    <div class="col-md-3 logore">
                        <img src="assets/images/logope.jpg" alt="">
        ...
        <div class="container">
            ...
            <div class="row about-row">
                <div class="col-md-5 about-img">
                    <img src="assets/images/kartun/ayam.png" alt="">
                </div>
                <div class="col-md-6 about-text">
                    <h1>Harga Ayam Di Wilayah Kota Medan</h1>
                    <p>Salah satu bahan baku hewani yang dikonsumsi oleh masyarakat Indonesia. Daging ayam potong yang sering dikonsumsi adalah
                    ...
                    <div class="about-featur">
                        ...
                        <table id="tabelbawah" class="table nowrap" style="width:100%; font-size:small">
                            ...
                            <?php for ($i = 26; $i < 28; $i++) : ?>
                                <tbody>
                                    <tr>
                                        <td><?= $data3['table'][$i]['00'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['01'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['02'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['03'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['04'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['05'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['06'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['07'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['08'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['09'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['10'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['11'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['12'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['13'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['14'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['15'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['16'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['17'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['18'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['19'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['20'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['21'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['22'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['23'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['24'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['25'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['26'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['27'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['28'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['29'] ?></td>
                                        <td>Rp.<?= $data3['table'][$i]['30'] ?></td>
                                    </tr>
                                </tbody>
                            <?php endfor ?>

                        </table>
                        <p style="font-style: italic; font-size: 12px;"> *Data di atas diambil dari web site pangan Sumatera Utara</a>
                        </p>
                    </div>
