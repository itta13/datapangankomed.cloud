        ...
        <div class="container">
            ...
            <div class="row about-row">
                <div class="col-md-5 about-img">
                    <img src="assets/images/kartun/gula.png" alt="">
                </div>
                <div class="col-md-6 about-text">
                    <h1>Harga Gula Pasir Di Wilayah Kota Medan</h1>
                    <p>Gula pasir merupakan salah satu dari sembilan bahan makanan pokok. Di Indonesia, salah satu kebutuhan bahan pokok dan merupakan komoditas pangan yang strategis setelah beras.</p>
