...
<head>
    ...
    <title>Harga Bawang Merah</title>
        ...
        <div class="container">
            ...
            <div class="row about-row">
                <div class="col-md-5 about-img">
                    <img src="assets/images/kartun/bawang.png" alt="">
                </div>
                <div class="col-md-6 about-text">
                    <h1>Harga Bawang Merah Di Wilayah Kota Medan</h1>
                    <p>Memiliki nama latin Allium ascalonium L, bawang merah merupakan salah satu komoditi holtikultura yang termasuk ke dalam sayuran rempah penambah cita rasa dan kenikmatan masakan. Sebagai pelengkap bumbu masakan, bawang merah berasal dari keluarga Liliceae.</p>
